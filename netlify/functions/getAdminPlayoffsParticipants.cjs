...
// recorded against week 19 (Wild Card) in week_payments regardless of which
// round is currently open -- matches PLAYOFFS_FIRST_WEEK in src/playoffsConfig.js.
